...
CREATE TABLE "new_Recording" (
    ...
    "recordingCount" INTEGER NOT NULL DEFAULT 2
);
INSERT INTO "new_Recording" ("MCAddress", "date", "filePath", "fileSize", "id", "name", "recordingLength") SELECT "MCAddress", "date", "filePath", "fileSize", "id", "name", "recordingLength" FROM "Recording";
